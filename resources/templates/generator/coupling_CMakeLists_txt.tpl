...
SET(LIBRARIES_TO_LINK "${QT_LIBRARIES} ${OPENGL_LIBRARIES} ${PLUGINS_AGROS_UTIL} ${PYTHON_MODLIBS} ${PYTHON_LIB} ${PLUGINS_AGROS_LIBRARY} ${PLUGINS_PYTHONLAB_LIBRARY} ${XSD_LIBRARY} ${XERCES_LIBRARY} ${PTHREAD_LIBRARY} ${UMFPACK_LIBRARIES} ${MUMPS_LIBRARIES} ${WINBLAS_LIBRARY} ${PLUGINS_BLAS_LIBRARY}")
IF(WIN32)
