...
TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${QT_LIBRARIES} ${OPENGL_LIBRARIES} ${BSON_LIBRARY} ${AGROS_UTIL} ${PYTHON_MODLIBS} ${PYTHON_LIB} ${HERMES2D_LIBRARY} ${HERMES_COMMON_LIBRARY} ${AGROS_LIBRARY} ${PYTHONLAB_LIBRARY} ${XSD_LIBRARY} ${MATIO_LIBRARY} ${XERCES_LIBRARY} ${PTHREAD_LIBRARY} ${UMFPACK_LIBRARIES} ${MUMPS_LIBRARIES} ${WINBLAS_LIBRARY} ${BLAS_LIBRARY} ${PARALUTION_LIBRARY})
