...
//{{#PARAMETERS}}    double {{PARAMETER_NAME}} = label->marker(m_fieldInfo)->value("{{PARAMETER_NAME}}").number();
//{{/PARAMETERS}}
//    double area = m_fieldInfo->initialMesh()->get_marker_area(geometry->elem_marker);
//    if(0)
//    {}
//    {{#VARIANT}}else if (this->m_variant == QString("{{ID}}"))
//        return {{EXPR}};{{/VARIANT}}
