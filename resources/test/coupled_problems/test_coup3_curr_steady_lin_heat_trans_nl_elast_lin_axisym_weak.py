...
print("Test: Coupling 3 - axisymetric, current lin, heat realy nonlin transient, elasticity lin,  weak ({0}): ".format(round(elapsed_time, 3)) + str(testV and testT and testD and testL1 and testL2))
