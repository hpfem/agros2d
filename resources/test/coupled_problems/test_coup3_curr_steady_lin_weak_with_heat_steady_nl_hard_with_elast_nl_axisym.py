...
print("Test: Coupling 3 - axisymetric, current lin weakly with (heat realy nonlin +hard elasticity nonlin): " + str(testV and testT and testD and testL1 and testL2))
