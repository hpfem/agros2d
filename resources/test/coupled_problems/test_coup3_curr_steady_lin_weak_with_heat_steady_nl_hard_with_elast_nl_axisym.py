...
elasticity.solver_parameters['tolerance'] = 0.001
...
print("Test: Coupling 3 - axisymetric, current lin weakly with ( heat realy nonlin +hard elasticity nonlin) ({0}): ".format(round(elapsed_time, 3)) + str(testV and testT and testD and testL1 and testL2))
