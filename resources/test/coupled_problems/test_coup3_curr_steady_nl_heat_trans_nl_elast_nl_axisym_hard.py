...
print("Test: Coupling 3 - axisymetric, current nonlin, heat realy nonlin transient, elasticity nonlin,  hard: " + str(testV and testT and testD and testL1 and testL2))