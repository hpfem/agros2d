...
// matrix dump format
AGROS_LIBRARY_API QString dumpFormatString(Hermes::Algebra::EMatrixDumpFormat format);
AGROS_LIBRARY_API QStringList dumpFormatStringKeys();
AGROS_LIBRARY_API QString dumpFormatToStringKey(Hermes::Algebra::EMatrixDumpFormat format);
AGROS_LIBRARY_API Hermes::Algebra::EMatrixDumpFormat dumpFormatFromStringKey(const QString &format);
