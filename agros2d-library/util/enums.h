...
AGROS_API QString nonlinearSolverConvergenceMeasurementString(Hermes::Hermes2D::NewtonSolver<double>::ConvergenceMeasurement measurement);
AGROS_API QStringList nonlinearSolverConvergenceMeasurementStringKeys();
AGROS_API QString nonlinearSolverConvergenceMeasurementToStringKey(Hermes::Hermes2D::NewtonSolver<double>::ConvergenceMeasurement measurement);
AGROS_API Hermes::Hermes2D::NewtonSolver<double>::ConvergenceMeasurement nonlinearSolverConvergenceMeasurementFromStringKey(const QString &measurement);
