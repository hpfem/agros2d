...
enum PhysicFieldIntegralVolume
{
    ...
    PHYSICFIELDINTEGRAL_VOLUME_MAGNETIC_LORENTZ_FORCE_X,
    PHYSICFIELDINTEGRAL_VOLUME_MAGNETIC_LORENTZ_FORCE_Y,
    PHYSICFIELDINTEGRAL_VOLUME_MAGNETIC_MAXWELL_FORCE_X,
    PHYSICFIELDINTEGRAL_VOLUME_MAGNETIC_MAXWELL_FORCE_Y,
    ...
    PHYSICFIELDINTEGRAL_VOLUME_MAGNETIC_TORQUE,
...
enum PhysicFieldIntegralSurface
{
    ...
    PHYSICFIELDINTEGRAL_SURFACE_MAGNETIC_MAXWELL_FORCE_X,
    PHYSICFIELDINTEGRAL_SURFACE_MAGNETIC_MAXWELL_FORCE_Y,
