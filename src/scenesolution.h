...
public:
    ...
    // mesh
    inline Hermes::Hermes2D::Views::Linearizer<double> &linInitialMeshView() { return m_linInitialMeshView; }
    inline Hermes::Hermes2D::Views::Linearizer<double> &linSolutionMeshView() { return m_linSolutionMeshView; }
    ...
    inline Hermes::Hermes2D::Views::Linearizer<double> &linContourView() { return m_linContourView; }
    ...
    inline Hermes::Hermes2D::Views::Linearizer<double> &linScalarView() { return m_linScalarView; }
    ...
    inline Hermes::Hermes2D::Views::Vectorizer<double> &vecVectorView() { return m_vecVectorView; }
    ...
    int findElementInVectorizer(Hermes::Hermes2D::Views::Vectorizer<double> &vecVectorView, const Point &point) const;
...
private:
    ...
    // mesh
    Hermes::Hermes2D::Views::Linearizer<double> m_linInitialMeshView;
    Hermes::Hermes2D::Views::Linearizer<double> m_linSolutionMeshView;

    // contour
    ViewScalarFilter<Scalar> *m_slnContourView; // scalar view solution
    Hermes::Hermes2D::Views::Linearizer<double> m_linContourView;

    // scalar view
    ViewScalarFilter<Scalar> *m_slnScalarView; // scalar view solution
    Hermes::Hermes2D::Views::Linearizer<double> m_linScalarView; // linealizer for scalar view
    ...
    Hermes::Hermes2D::Views::Vectorizer<double> m_vecVectorView; // vectorizer for vector view
