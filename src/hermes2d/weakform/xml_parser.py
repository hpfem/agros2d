...
class XmlParser:
    ...
    def parse_xml_file(self, filename):
        ...
        boundary_types = ['matrix', 'vector', 'essential']
        
        # opens file and initializes xml parser    
        fread = open(Config.modules_dir + filename, 'r')
        ...
        for subnode in nodes[0].childNodes:
            if subnode.nodeName == 'item':           
                ...
                variable.unit = str(subnode.attributes['unit'].value)            
                ...
                for subsubnode in subnode.childNodes:
                    if subsubnode.nodeName == 'boundary':
                        ...
                        for element in  subsubnode.childNodes:                                               
                            if element.nodeName in boundary_types:                                                         
    ...
    def info(self):
        ...
        for boundary in self.boundaries:                                          
            ...
            for weakform in boundary.weakforms:
                print (weakform.id, weakform.i, weakform.j, weakform.type, 
                       weakform.coordinate_type, weakform.integral_type)                                                                   
