...
{
    double current_density, permeability, remanence, remanence_angle;
    char *name;
    if (PyArg_ParseTuple(args, "sdddd", &name, &current_density, &permeability, &remanence, &remanence_angle))
    {
        // check name
