...
*/
#ifndef __H2D_SOLVER_NEWTON_AGROS_H_
#define __H2D_SOLVER_NEWTON_AGROS_H_
...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    class HERMES_API NewtonSolverAgros : public NonlinearSolver<Scalar>
    {
    public:
      NewtonSolverAgros(DiscreteProblem<Scalar>* dp);
      NewtonSolverAgros(DiscreteProblem<Scalar>* dp, Hermes::MatrixSolverType matrix_solver_type);
