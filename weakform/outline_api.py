...
class outline(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='outline', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='outline'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='outline', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='outline'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for child_ in self.child:
            ...
            child_.exportLiteral(outfile, level, name_='node')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class node(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='node'):
        if self.hidden is not None and 'hidden' not in already_processed:
            ...
            outfile.write(' hidden=%s' % (self.gds_format_string(quote_attrib(self.hidden).encode(ExternalEncoding), input_name='hidden'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='node', fromsubclass_=False):
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="outline",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from outline_api import *\n\n')
    sys.stdout.write('import outline_api as model_\n\n')
