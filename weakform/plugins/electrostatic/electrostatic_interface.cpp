...
{
    qDebug() << "matrixFormVol - problemId.coordinateType" << problemId.coordinateType;
...
const std::string &area, SceneMaterial *materialSource, Material *materialTarget, int offsetI, int offsetJ)
{
    ...
    qDebug() << "vectorFormVol - problemId.coordinateType" << problemId.coordinateType;
...
{
    qDebug() << "matrixFormSurf - problemId.coordinateType" << problemId.coordinateType;
...
const std::string &area, SceneBoundary *boundary, int offsetI, int offsetJ)
{
    qDebug() << "vectorFormSurf - problemId.coordinateType" << problemId.coordinateType;
...
{
    qDebug() << "exactSolution - problemId.coordinateType" << problemId.coordinateType;
    qDebug() << "exactSolution - problemId.linearityType" << problemId.linearityType;
    qDebug() << "i" << i;
    ...
    {
        qDebug() << "CustomEssentialFormSurf_electrostatic_potential_1_0_steadystate_linear_";
