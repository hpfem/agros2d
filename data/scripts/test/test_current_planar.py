...
testE = agros2d.test("Electric field", point["E"], 0.486928)
testEx = agros2d.test("Electric field - x", point["Ex"], -0.123527)
testEy = agros2d.test("Electric field - y", point["Ey"], -0.470999)
