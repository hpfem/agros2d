...
elasticity.add_material("Material 1", {"elasticity_young_modulus" : 2e11, "elasticity_poisson_ratio" : 0.33, "elasticity_force_x" : -1e6, "elasticity_force_y" : 0, "elasticity_alpha" : 1e-6, "elasticity_temperature_difference" : 10, "elasticity_temperature_reference" : 20})
elasticity.add_material("Material 2", {"elasticity_young_modulus" : 1e11, "elasticity_poisson_ratio" : 0.33, "elasticity_force_x" : 0, "elasticity_force_y" : 3e4, "elasticity_alpha" : 1e-6, "elasticity_temperature_difference" : 10, "elasticity_temperature_reference" : 20})
