...
# point value
point = pointresult(1.327264, 0.041087)
# testVonMises = test("Von Mises stress", point["mises"], 1.175226e5)
# testTresca = test("Tresca stress", point["tresca"], 1.344939e5)
testd = test("Displacement", point["d"], 1.682194e-5)
testdx = test("Displacement - x", point["dx"], 1.681777e-5)
testdy = test("Displacement - y", point["dy"], -3.751169e-7, 0.1)
