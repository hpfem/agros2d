...
# coupling
problem.set_coupling_type("magnetic", "heat", "hard")
...
print("Test: Coupling 2 - axisymmetric, mag harm + heat steady, both nonlin, hard ({0}): ".format(round(elapsed_time, 3)) + str(testA and testT))
