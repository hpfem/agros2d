...
.. image:: ./curvilinear_elements/elements.png
   :align: center
   :scale: 30%
   :alt: Curvilinear and edge elements at the same geometry

Fig: Curvilinear and edge elements at the same ilustrative geometry

Ilustrative example ():

.. image:: ./curvilinear_elements/mesh-edge_elements.png
   :align: center
   :scale: 50%
   :alt: Edge elements mesh
...
Fig.: Edge (left) and curvilinear (right) meshes
